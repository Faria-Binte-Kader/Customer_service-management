...
Intern::Intern():Person(),Student(),Employee(),intership_period(0)
{
    //ctor
    generatePassword();
    total_interns++;
...
void Intern::displayinfo()
{
      ...
      std::cout<<"Internship period: "<<getPeriod()<<std::endl;
      std::cout<<"Designation: "<<Student::getCourse()<<std::endl;
